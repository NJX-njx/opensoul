...
This directory contains the **BlueBubbles external channel plugin** for OpenSoul.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `opensoul/plugin-sdk` helpers.
