...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: (typeof import("opensoul/plugin-sdk"))["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    (typeof import("opensoul/plugin-sdk"))["channel"]["mentions"]["buildMentionRegexes"]
  >;
                ...
                try {
                  await sendMessageMatrix(
                    ...
                    [
                      ...
                      "opensoul pairing approve matrix <code>",
                    ].join("\n"),
                    { client },
                  );
                } catch (err) {
