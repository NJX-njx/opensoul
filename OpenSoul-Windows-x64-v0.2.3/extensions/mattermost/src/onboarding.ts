import type { ChannelOnboardingAdapter, OpenSoulConfig, WizardPrompter } from "opensoul/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.opensoul.ai/channels/mattermost",
    ].join("\n"),
