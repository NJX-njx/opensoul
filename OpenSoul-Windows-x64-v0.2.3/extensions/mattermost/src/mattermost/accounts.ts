...
export function listMattermostAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenSoulConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenSoulConfig): ResolvedMattermostAccount[] {
