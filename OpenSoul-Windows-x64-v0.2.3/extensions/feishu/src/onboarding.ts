...
function setFeishuDmPolicy(cfg: OpenSoulConfig, dmPolicy: DmPolicy): OpenSoulConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: OpenSoulConfig, allowFrom: string[]): OpenSoulConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: OpenSoulConfig, groupAllowFrom: string[]): OpenSoulConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
