...
export function listGoogleChatAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenSoulConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenSoulConfig): ResolvedGoogleChatAccount[] {
