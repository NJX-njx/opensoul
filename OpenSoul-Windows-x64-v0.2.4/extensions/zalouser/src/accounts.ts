...
export function listZalouserAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenSoulConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenSoulConfig, accountId: string): ZalouserAccountConfig {
