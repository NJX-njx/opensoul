...
Official Voice Call plugin for **OpenSoul**.
...
Docs: `https://docs.opensoul.ai/plugins/voice-call`
Plugin system: `https://docs.opensoul.ai/plugin`

## Install (local dev)

### Option A: install via OpenSoul (recommended)
...
```bash
mkdir -p ~/.opensoul/extensions
cp -R extensions/voice-call ~/.opensoul/extensions/voice-call
cd ~/.opensoul/extensions/voice-call && pnpm install
```
