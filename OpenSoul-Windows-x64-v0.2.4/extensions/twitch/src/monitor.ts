...
import type { ReplyPayload, OpenSoulConfig } from "opensoul/plugin-sdk";
import { createReplyPrefixOptions } from "opensoul/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OpenSoulConfig;
