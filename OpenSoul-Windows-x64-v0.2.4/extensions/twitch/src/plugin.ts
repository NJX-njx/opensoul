/**
 * Twitch channel plugin for OpenSoul.
 *
 * Main plugin export combining all adapters (outbound, actions, status, gateway).
 * This is the primary entry point for the Twitch channel integration.
 */

import type { OpenSoulConfig } from "opensoul/plugin-sdk";
import { buildChannelConfigSchema } from "opensoul/plugin-sdk";
import type {
 ...
 * for OpenSoul. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<TwitchAccountConfig> = {
  ...
  config: {
    ...
    listAccountIds: (cfg: OpenSoulConfig): string[] => listAccountIds(cfg),

    /** Resolve an account config by ID */
    resolveAccount: (cfg: OpenSoulConfig, accountId?: string | null): TwitchAccountConfig => {
    ...
    isConfigured: (_account: unknown, cfg: OpenSoulConfig): boolean => {
