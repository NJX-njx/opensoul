...
export function listBlueBubblesAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenSoulConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenSoulConfig): ResolvedBlueBubblesAccount[] {
